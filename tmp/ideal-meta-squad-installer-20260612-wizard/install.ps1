...
if ([string]::IsNullOrWhiteSpace($RawBase)) {
  $RawBase = "https://raw.githubusercontent.com/eduardocarezia/auto-instaldor/ideal-meta-squad-installer-20260611/tmp/ideal-meta-squad-installer-20260612-wizard"
}
